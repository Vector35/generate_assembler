...
{     "beqc GPREG , GPREG , OFFS",{0x20220000,0x03FFFFFF}}, // 001000xxxxxxxxxxxxxxxxxxxxxxxxxx beqc $at, $v0, 0
{     "beql GPREG , GPREG , OFFS",{0x50010000,0x03FFFFFF}}, // 010100xxxxxxxxxxxxxxxxxxxxxxxxxx beql $zero, $at, 4
{              "beqz GPREG , NUM",{0x10200000,0x03E0FFFF}}, // 000100xxxxx00000xxxxxxxxxxxxxxxx beqz $at, 4
{          "beqzalc GPREG , OFFS",{0x20010000,0x001FFFFF}}, // 00100000000xxxxxxxxxxxxxxxxxxxxx beqzalc $at, 0
{            "beqzc GPREG , OFFS",{0xD8200000,0x03FFFFFF}}, // 110110xxxxxxxxxxxxxxxxxxxxxxxxxx beqzc $at, 0
{            "beqzl GPREG , OFFS",{0x50000000,0x0000FFFF}}, // 0101000000000000xxxxxxxxxxxxxxxx beqzl $zero, 4
{     "bgec GPREG , GPREG , OFFS",{0x58220000,0x03FFFFFF}}, // 010110xxxxxxxxxxxxxxxxxxxxxxxxxx bgec $at, $v0, 0
{    "bgeuc GPREG , GPREG , OFFS",{0x18220000,0x03FFFFFF}}, // 000110xxxxxxxxxxxxxxxxxxxxxxxxxx bgeuc $at, $v0, 0
{             "bgez GPREG , OFFS",{0x04010000,0x03E0FFFF}}, // 000001xxxxx00001xxxxxxxxxxxxxxxx bgez $zero, 4
{          "bgezalc GPREG , OFFS",{0x18210000,0x03FFFFFF}}, // 000110xxxxxxxxxxxxxxxxxxxxxxxxxx bgezalc $at, 0
{          "bgezall GPREG , OFFS",{0x04130000,0x03E0FFFF}}, // 000001xxxxx10011xxxxxxxxxxxxxxxx bgezall $zero, 4
{            "bgezc GPREG , OFFS",{0x58210000,0x03FFFFFF}}, // 010110xxxxxxxxxxxxxxxxxxxxxxxxxx bgezc $at, 0
...
{     "bltc GPREG , GPREG , OFFS",{0x5C220000,0x03FFFFFF}}, // 010111xxxxxxxxxxxxxxxxxxxxxxxxxx bltc $at, $v0, 0
{    "bltuc GPREG , GPREG , OFFS",{0x1C220000,0x03FFFFFF}}, // 000111xxxxxxxxxxxxxxxxxxxxxxxxxx bltuc $at, $v0, 0
{             "bltz GPREG , OFFS",{0x04000000,0x03E0FFFF}}, // 000001xxxxx00000xxxxxxxxxxxxxxxx bltz $zero, 4
{          "bltzalc GPREG , OFFS",{0x1C210000,0x03FFFFFF}}, // 000111xxxxxxxxxxxxxxxxxxxxxxxxxx bltzalc $at, 0
{          "bltzall GPREG , OFFS",{0x04120000,0x03E0FFFF}}, // 000001xxxxx10010xxxxxxxxxxxxxxxx bltzall $zero, 4
{            "bltzc GPREG , OFFS",{0x5C210000,0x03FFFFFF}}, // 010111xxxxxxxxxxxxxxxxxxxxxxxxxx bltzc $at, 0
...
{     "bnec GPREG , GPREG , OFFS",{0x60220000,0x03FFFFFF}}, // 011000xxxxxxxxxxxxxxxxxxxxxxxxxx bnec $at, $v0, 0
...
{            "bnezc GPREG , OFFS",{0xF8200000,0x03FFFFFF}}, // 111110xxxxxxxxxxxxxxxxxxxxxxxxxx bnezc $at, 0
...
{                     "break NUM",{0x0001000D,0x03FF0000}}, // 000000xxxxxxxxxx0000000000001101 break 1
{               "break NUM , NUM",{0x0000004D,0x03FFFFC0}}, // 000000xxxxxxxxxxxxxxxxxxxx001101 break 0, 1
...
{                   "cache , ( )",{0x7C000025,0x00000000}}, // 01111100000000000000000000100101 cache , ()
{               "cache , ( NUM )",{0x7C0000A5,0x03E0FF80}}, // 011111xxxxx00000xxxxxxxxx0100101 cache , (1)
{               "cache , NUM ( )",{0x7C010025,0x001F0000}}, // 01111100000xxxxx0000000000100101 cache , 1()
{           "cache , NUM ( NUM )",{0x7C0100A5,0x03FFFF80}}, // 011111xxxxxxxxxxxxxxxxxxx0100101 cache , 1(1)
...
{                    "jalr GPREG",{0x0000F809,0x03E00000}}, // 000000xxxxx000001111100000001001 jalr $zero
{            "jalr GPREG , GPREG",{0x00000809,0x03E0F800}}, // 000000xxxxx00000xxxxx00000001001 jalr $at, $zero
{                 "jalr.hb GPREG",{0x0000FC09,0x03E00000}}, // 000000xxxxx000001111110000001001 jalr.hb $zero
...
{      "lb GPREG , NUM ( GPREG )",{0x80000001,0x03FFFFFF}}, // 100000xxxxxxxxxxxxxxxxxxxxxxxxxx lb $zero, 1($zero)
{         "lbu GPREG , ( GPREG )",{0x90000000,0x03FF0000}}, // 100100xxxxxxxxxx0000000000000000 lbu $zero, ($zero)
{     "lbu GPREG , NUM ( GPREG )",{0x90000001,0x03FFFFFF}}, // 100100xxxxxxxxxxxxxxxxxxxxxxxxxx lbu $zero, 1($zero)
...
{     "ld.b WREG , NUM ( GPREG )",{0x78010020,0x03FFFFC0}}, // 011110xxxxxxxxxxxxxxxxxxxx100000 ld.b $w0, 1($zero)
{         "ld.d WREG , ( GPREG )",{0x78000023,0x0000FFC0}}, // 0111100000000000xxxxxxxxxx100011 ld.d $w0, ($zero)
{     "ld.d WREG , NUM ( GPREG )",{0x78010023,0x03FFFFC0}}, // 011110xxxxxxxxxxxxxxxxxxxx100011 ld.d $w0, 8($zero)
{         "ld.h WREG , ( GPREG )",{0x78000021,0x0000FFC0}}, // 0111100000000000xxxxxxxxxx100001 ld.h $w0, ($zero)
{     "ld.h WREG , NUM ( GPREG )",{0x78010021,0x03FFFFC0}}, // 011110xxxxxxxxxxxxxxxxxxxx100001 ld.h $w0, 2($zero)
{         "ld.w WREG , ( GPREG )",{0x78000022,0x0000FFC0}}, // 0111100000000000xxxxxxxxxx100010 ld.w $w0, ($zero)
{     "ld.w WREG , NUM ( GPREG )",{0x78010022,0x03FFFFC0}}, // 011110xxxxxxxxxxxxxxxxxxxx100010 ld.w $w0, 4($zero)
{         "ldc1 FREG , ( GPREG )",{0xD4000000,0x03FF0000}}, // 110101xxxxxxxxxx0000000000000000 ldc1 $f0, ($zero)
{     "ldc1 FREG , NUM ( GPREG )",{0xD4000001,0x03FFFFFF}}, // 110101xxxxxxxxxxxxxxxxxxxxxxxxxx ldc1 $f0, 1($zero)
{               "ldc2 CASH , ( )",{0x49C00000,0x001F0000}}, // 01001001110xxxxx0000000000000000 ldc2 $0, ()
{           "ldc2 CASH , ( NUM )",{0x49C00001,0x001FFFFF}}, // 01001001110xxxxxxxxxxxxxxxxxxxxx ldc2 $0, (1)
...
{      "lh GPREG , NUM ( GPREG )",{0x84000001,0x03FFFFFF}}, // 100001xxxxxxxxxxxxxxxxxxxxxxxxxx lh $zero, 1($zero)
{         "lhu GPREG , ( GPREG )",{0x94000000,0x03FF0000}}, // 100101xxxxxxxxxx0000000000000000 lhu $zero, ($zero)
{     "lhu GPREG , NUM ( GPREG )",{0x94000001,0x03FFFFFF}}, // 100101xxxxxxxxxxxxxxxxxxxxxxxxxx lhu $zero, 1($zero)
...
{      "ll GPREG , NUM ( GPREG )",{0x7C0000B6,0x03FFFFC0}}, // 011111xxxxxxxxxxxxxxxxxxxx110110 ll $zero, 1($zero)
{         "lld GPREG , ( GPREG )",{0x7C000037,0x03FF0040}}, // 011111xxxxxxxxxx000000000x110111 lld $zero, ($zero)
{     "lld GPREG , NUM ( GPREG )",{0x7C0000B7,0x03FFFFC0}}, // 011111xxxxxxxxxxxxxxxxxxxx110111 lld $zero, 1($zero)
...
{      "lw GPREG , NUM ( GPREG )",{0x8C000001,0x03FFFFFF}}, // 100011xxxxxxxxxxxxxxxxxxxxxxxxxx lw $zero, 1($zero)
{         "lwc1 FREG , ( GPREG )",{0xC4000000,0x03FF0000}}, // 110001xxxxxxxxxx0000000000000000 lwc1 $f0, ($zero)
{     "lwc1 FREG , NUM ( GPREG )",{0xC4000001,0x03FFFFFF}}, // 110001xxxxxxxxxxxxxxxxxxxxxxxxxx lwc1 $f0, 1($zero)
{               "lwc2 CASH , ( )",{0x49400000,0x001F0000}}, // 01001001010xxxxx0000000000000000 lwc2 $0, ()
{           "lwc2 CASH , ( NUM )",{0x49400001,0x001FFFFF}}, // 01001001010xxxxxxxxxxxxxxxxxxxxx lwc2 $0, (1)
...
{                "pref , ( NUM )",{0x7C0000B5,0x03E0FF80}}, // 011111xxxxx00000xxxxxxxxx0110101 pref , (1)
{                "pref , NUM ( )",{0x7C010035,0x001F0000}}, // 01111100000xxxxx0000000000110101 pref , 1()
{            "pref , NUM ( NUM )",{0x7C0100B5,0x03FFFF80}}, // 011111xxxxxxxxxxxxxxxxxxx0110101 pref , 1(1)
...
{      "sb GPREG , NUM ( GPREG )",{0xA0000001,0x03FFFFFF}}, // 101000xxxxxxxxxxxxxxxxxxxxxxxxxx sb $zero, 1($zero)
{          "sc GPREG , ( GPREG )",{0x7C000026,0x03FF0040}}, // 011111xxxxxxxxxx000000000x100110 sc $zero, ($zero)
{      "sc GPREG , NUM ( GPREG )",{0x7C0000A6,0x03FFFFC0}}, // 011111xxxxxxxxxxxxxxxxxxxx100110 sc $zero, 1($zero)
{         "scd GPREG , ( GPREG )",{0x7C000027,0x03FF0040}}, // 011111xxxxxxxxxx000000000x100111 scd $zero, ($zero)
{     "scd GPREG , NUM ( GPREG )",{0x7C0000A7,0x03FFFFC0}}, // 011111xxxxxxxxxxxxxxxxxxxx100111 scd $zero, 1($zero)
{                         "sdbbp",{0x0000000E,0x00000000}}, // 00000000000000000000000000001110 sdbbp
{                     "sdbbp NUM",{0x0000004E,0x03FFFFC0}}, // 000000xxxxxxxxxxxxxxxxxxxx001110 sdbbp 1
{         "sdc1 FREG , ( GPREG )",{0xF4000000,0x03FF0000}}, // 111101xxxxxxxxxx0000000000000000 sdc1 $f0, ($zero)
{     "sdc1 FREG , NUM ( GPREG )",{0xF4000001,0x03FFFFFF}}, // 111101xxxxxxxxxxxxxxxxxxxxxxxxxx sdc1 $f0, 1($zero)
{               "sdc2 CASH , ( )",{0x49E00000,0x001F0000}}, // 01001001111xxxxx0000000000000000 sdc2 $0, ()
{           "sdc2 CASH , ( NUM )",{0x49E00001,0x001FFFFF}}, // 01001001111xxxxxxxxxxxxxxxxxxxxx sdc2 $0, (1)
...
{      "sh GPREG , NUM ( GPREG )",{0xA4000001,0x03FFFFFF}}, // 101001xxxxxxxxxxxxxxxxxxxxxxxxxx sh $zero, 1($zero)
...
{       "sll GPREG , GPREG , NUM",{0x00000080,0x001FFFC0}}, // 00000000000xxxxxxxxxxxxxxx000000 sll $zero, $zero, 2
...
{     "st.b WREG , NUM ( GPREG )",{0x78010024,0x03FFFFC0}}, // 011110xxxxxxxxxxxxxxxxxxxx100100 st.b $w0, 1($zero)
{         "st.d WREG , ( GPREG )",{0x78000027,0x0000FFC0}}, // 0111100000000000xxxxxxxxxx100111 st.d $w0, ($zero)
{     "st.d WREG , NUM ( GPREG )",{0x78010027,0x03FFFFC0}}, // 011110xxxxxxxxxxxxxxxxxxxx100111 st.d $w0, 8($zero)
{         "st.h WREG , ( GPREG )",{0x78000025,0x0000FFC0}}, // 0111100000000000xxxxxxxxxx100101 st.h $w0, ($zero)
{     "st.h WREG , NUM ( GPREG )",{0x78010025,0x03FFFFC0}}, // 011110xxxxxxxxxxxxxxxxxxxx100101 st.h $w0, 2($zero)
{         "st.w WREG , ( GPREG )",{0x78000026,0x0000FFC0}}, // 0111100000000000xxxxxxxxxx100110 st.w $w0, ($zero)
{     "st.w WREG , NUM ( GPREG )",{0x78010026,0x03FFFFC0}}, // 011110xxxxxxxxxxxxxxxxxxxx100110 st.w $w0, 4($zero)
{     "sub GPREG , GPREG , GPREG",{0x00200022,0x03FFF800}}, // 000000xxxxxxxxxxxxxxx00000100010 sub $zero, $at, $zero
...
{    "subu GPREG , GPREG , GPREG",{0x00200023,0x03FFF800}}, // 000000xxxxxxxxxxxxxxx00000100011 subu $zero, $at, $zero
...
{      "sw GPREG , NUM ( GPREG )",{0xAC000001,0x03FFFFFF}}, // 101011xxxxxxxxxxxxxxxxxxxxxxxxxx sw $zero, 1($zero)
{         "swc1 FREG , ( GPREG )",{0xE4000000,0x03FF0000}}, // 111001xxxxxxxxxx0000000000000000 swc1 $f0, ($zero)
{     "swc1 FREG , NUM ( GPREG )",{0xE4000001,0x03FFFFFF}}, // 111001xxxxxxxxxxxxxxxxxxxxxxxxxx swc1 $f0, 1($zero)
{               "swc2 CASH , ( )",{0x49600000,0x001F0000}}, // 01001001011xxxxx0000000000000000 swc2 $0, ()
{           "swc2 CASH , ( NUM )",{0x49600001,0x001FFFFF}}, // 01001001011xxxxxxxxxxxxxxxxxxxxx swc2 $0, (1)
{                          "sync",{0x0000000F,0x03FFF800}}, // 000000xxxxxxxxxxxxxxx00000001111 sync
{                      "sync NUM",{0x0000004F,0x03FFFFC0}}, // 000000xxxxxxxxxxxxxxxxxxxx001111 sync 1
{                       "syscall",{0x0000000C,0x00000000}}, // 00000000000000000000000000001100 syscall
{                   "syscall NUM",{0x0000004C,0x03FFFFC0}}, // 000000xxxxxxxxxxxxxxxxxxxx001100 syscall 1
{             "teq GPREG , GPREG",{0x00000034,0x03FF0000}}, // 000000xxxxxxxxxx0000000000110100 teq $zero, $zero
{       "teq GPREG , GPREG , NUM",{0x00000074,0x03FFFFC0}}, // 000000xxxxxxxxxxxxxxxxxxxx110100 teq $zero, $zero, 1
{             "tge GPREG , GPREG",{0x00000030,0x03FF0000}}, // 000000xxxxxxxxxx0000000000110000 tge $zero, $zero
{       "tge GPREG , GPREG , NUM",{0x00000070,0x03FFFFC0}}, // 000000xxxxxxxxxxxxxxxxxxxx110000 tge $zero, $zero, 1
{            "tgeu GPREG , GPREG",{0x00000031,0x03FF0000}}, // 000000xxxxxxxxxx0000000000110001 tgeu $zero, $zero
{      "tgeu GPREG , GPREG , NUM",{0x00000071,0x03FFFFC0}}, // 000000xxxxxxxxxxxxxxxxxxxx110001 tgeu $zero, $zero, 1
...
{       "tlt GPREG , GPREG , NUM",{0x00000072,0x03FFFFC0}}, // 000000xxxxxxxxxxxxxxxxxxxx110010 tlt $zero, $zero, 1
{            "tltu GPREG , GPREG",{0x00000033,0x03FF0000}}, // 000000xxxxxxxxxx0000000000110011 tltu $zero, $zero
{      "tltu GPREG , GPREG , NUM",{0x00000073,0x03FFFFC0}}, // 000000xxxxxxxxxxxxxxxxxxxx110011 tltu $zero, $zero, 1
{             "tne GPREG , GPREG",{0x00000036,0x03FF0000}}, // 000000xxxxxxxxxx0000000000110110 tne $zero, $zero
{       "tne GPREG , GPREG , NUM",{0x00000076,0x03FFFFC0}}, // 000000xxxxxxxxxxxxxxxxxxxx110110 tne $zero, $zero, 1
